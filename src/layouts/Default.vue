                ...
                <el-row>
                    <el-col :span="10">
                        <el-menu @select="selectTopbar" :default-active="topbar.active" mode="horizontal" menu-trigger="click">
                            ...
                            <el-submenu index="#webSites" v-if="vblog.websites
                            .length>0">
                                <template slot="title">其他网站</template>
                                <el-menu-item :index="'#webSites-'+index" v-for="(item,index) in vblog.websites" :key="'#webSites'+index">{{item.url}}</el-menu-item>
                            </el-submenu>
                        </el-menu>
                    </el-col>
                    ...
                    <el-col :span="2" style="text-align: center;">
                        <img v-popover:bigAvatar :src="vblog.avatarUrl" style="margin-top: 4px;margin-right: 10px;width:52px; height:52px; border-radius:5px; border: 1px solid #EBEEF5"
                        />
                        <el-popover ref="bigAvatar" placement="top-start" :title="vblog.githubUsername" width="200" trigger="hover">
                            <i class="el-icon-star-on"></i>&emsp;{{vblog.GithubUsername}}
                            <br>
                            <i class="el-icon-location"></i>&emsp;{{vblog.location}}
                            <br>
                            <img :src="vblog.avatarUrl" style="width: 200px;height: 200px;">
                        </el-popover>
                    </el-col>
                </el-row>
...
export default {
  ...
  methods: {
      ...
      selectTopbar(index) {
          ...
          switch (index) {
              case "#githubHome":
                  window.open('https://github.com/' + this.vblog.githubUsername)
                  break
              case "#blog":
                  if (this.blog) {
